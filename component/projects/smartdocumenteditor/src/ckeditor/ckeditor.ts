...
export default class DecoupledEditor extends DecoupledEditorBase {
    ...
    static getCssStyles(filterStylesheetNames?: string[]) {
        let css = [];
        let filterByNames = [];
...
DecoupledEditor.defaultConfig = {
    ...
    licenseKey: 'eyJhbGciOiJFUzI1NiJ9..tSACgMxkAKeNz7KE3AVFn-mVPzvopMP9SUP64XBPK_z53uqxFRBxC6bjKbjivVYSXhnksvwJokCZFTSp_aeL6Q'
} as EditorConfig;
